            ...
            >
              <v-form class="form-info">
                <div class="mb-2" height="54">
                  Tên sản phẩm <span style="color: blue">*</span>
                </div>
                <v-text-field
                  class="mb-4"
                  ...
                  hide-details
                ></v-text-field>
                <div class="mb-2">Giá <span style="color: blue">*</span></div>
                <v-text-field
                  class="mb-4"
                  style="border: 1px solid #868fa029; border-radius: 6px"
                ...
                ></v-text-field>
                <div class="mb-2">
                  Số lượng <span style="color: blue">*</span>
                </div>
                <v-text-field
                  class="mb-4"
                  style="border: 1px solid #868fa029; border-radius: 6px"
                  ...
                  flat
                ></v-text-field>
                <div class="mb-2">Mô tả <span style="color: blue">*</span></div>
                <v-textarea
                  class="mb-4"
                  row-height="32"
                  rows="4"
                ...
                ></v-textarea>
                <div class="mb-2">
                  Ảnh sản phẩm <span style="color: blue">*</span>
                </div>
                <v-text-field
                  class="mb-4"
                  style="border: 1px solid #868fa029; border-radius: 6px"
